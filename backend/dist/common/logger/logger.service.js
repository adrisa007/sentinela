...
let CustomLoggerService = class CustomLoggerService {
    constructor(configService) {
        ...
        this.logger = winston.createLogger({
            ...
            format: winston.format.combine(winston.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss.SSS' }), winston.format.errors({ stack: true }), winston.format.json(), winston.format.printf((info) => {
